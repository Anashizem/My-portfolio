...
function Contact() {
  ...
  const handleSubmit = (e) => {
    ...
    emailjs
      .send(
        'service_9h7ffd5', // paste your ServiceID here (you'll get one when your service is created).
        'template_1qqqov8', // paste your TemplateID here (you'll find it under email templates).
        {
          from_name: form.name,
          to_name: 'Anas hizem', // put your name here.
          from_email: form.email,
          to_email: 'anas.hizem@ensi-uma.tn', //put your email here.
          message: form.message,
        },
        'tzMCyccDeAQ6VRO0I' //paste your Public Key here. You'll get it in your profile section.
      )
      .then(
        () => {
          setLoading(false);
